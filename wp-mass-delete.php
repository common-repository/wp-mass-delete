...
/*
  ...
  Description: This plugin is intended to mass delete WordPress posts and pages. Please use it responsibly!
 */
...
function wpmd_show_menu() {
    ...
    <div class="wrap">
        ...
        <p>This plugin is intended to mass delete WordPress posts and pages. Please use it responsibly!</p>
